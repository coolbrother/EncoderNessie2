...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 15.04; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.018; // 1.0 / rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = Math.toRadians(249.06);
